...
def extrair_dados_prefeitura(dados_cidade, hospitais_campanha, leitos_municipais, leitos_municipais_privados, leitos_municipais_total):
    ...
    try:
        ...
        if(dados_novos):
            ...
            hospitais_campanha.loc[((hospitais_campanha.data == data_str) & (hospitais_campanha.hospital == 'Anhembi')), 'ocupação_uti'] = formata_numero(hm_camp.iat[2, 1].split('(')[0])
...
def pre_processamento_cidade(dados_cidade, hospitais_campanha, leitos_municipais, leitos_municipais_privados, leitos_municipais_total):
    ...
    def calcula_dia(series):
        ...
        print(dados_cidade.loc[dados_cidade.dia == series['dia']].index.values)
        indice = dados_cidade.loc[dados_cidade.dia == series['dia']].index.values.item() - 1
